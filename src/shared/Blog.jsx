  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800 dark:text-gray-200">
      <h1 className="text-4xl font-bold text-center text-blue-600 mb-4">
        Empowering People Through Micro Tasks
      </h1>
      ...
      <div className="space-y-5 leading-relaxed text-justify">
        <p>
          The world of work is changing rapidly, and micro-tasking has become a new way for people to earn money online.
          Micro tasks are small, simple jobs that can be completed quickly — like filling out surveys, testing apps, or
          reviewing content.
        </p>

        <p>
          Our Micro Task Platform connects workers and buyers seamlessly. Buyers can post tasks, set requirements, and
          pay using coins, while workers complete tasks to earn coins that can later be withdrawn as real money.
        </p>

        <p>
          This system creates opportunities for students, freelancers, and individuals looking for extra income, while
          also helping businesses get their jobs done faster at an affordable cost.
        </p>

        <p>
          With features like secure payments, role-based dashboards, and a smooth workflow for submissions and
          approvals, the platform ensures fairness, transparency, and accessibility for everyone.
        </p>

        <p>
          In conclusion, micro-tasking is not just about earning money online — it is about creating a global
          collaboration space where everyone benefits.
        </p>
      </div>
    </div>
  );
